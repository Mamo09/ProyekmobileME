...
class TurnamenRecyclerAdapter(private var turnamenList:List<TurnamenDataClass>, private var listener: TurnamenRecyclerAdapter.OnItemClickListener): RecyclerView.Adapter<TurnamenRecyclerAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val v = LayoutInflater.from(parent.context).inflate(R.layout.turnamen_card_layout,parent,false)
        return ViewHolder(v)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val currentItem = turnamenList[position]
        ...
        holder.itemCategory.text = currentItem.categories
    }

    override fun getItemCount(): Int {
        return turnamenList.size
    }
    ...
    inner class ViewHolder(itemView: View):RecyclerView.ViewHolder(itemView),View.OnClickListener{
        ...
        var itemCategory: TextView = itemView.findViewById(R.id.item_kategori)
